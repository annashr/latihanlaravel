...
<head>
  ...
  <!-- Plugin CSS -->
  <link href="{{asset('asset/vendor/magnific-popup/magnific-popup.css')}}" rel="stylesheet" type="text/css">

  <!-- Custom styles for this template -->
  <link href="{{ asset('asset/css/freelancer.min.css') }}" rel="stylesheet">
